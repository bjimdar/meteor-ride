...
namespace Vectria.MeteorRide.Project
{
    ...
    [Guid("F25148B5-67AF-4FA3-9D31-121D55D1E19C")]
    public class MeteorProjectNode : ProjectNode
    {
        #region Enum for image list
        internal enum MeteorProjectImageName
        {
            Project = 0,
        }
        #endregion
        ...
        #region Constants
        internal const string ProjectTypeName = "MeteorProject";
        #endregion
        ...
        #region Constructors
        /// <summary>
        /// Initializes the <see cref="MeteorProjectNode"/> class.
        /// </summary>
        static MeteorProjectNode()
        {
            imageList = Utilities.GetImageList(typeof(MeteorProjectNode).Assembly.GetManifestResourceStream(
                "Vectria.MeteorRide.Resources.MeteorProjectImageList.bmp"));
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="MeteorProjectNode"/> class.
        /// </summary>
        /// <param name="package">Value of the project package for initialize internal package field.</param>
        public MeteorProjectNode(MeteorPackage package)
        {
        ...
        {
            get { return typeof(MeteorProjectFactory).GUID; }
        }
        ...
        public override int ImageIndex
        {
            get
            {
                return imageOffset + (int)MeteorProjectImageName.Project;
            }
        }
        ...
        {
            return new OAMeteorProject(this);
        }
        ...
        {
            MeteorFileNode node = new MeteorFileNode(this, item);
        ...
        protected override Guid[] GetConfigurationIndependentPropertyPages()
        {
            ...
            result[0] = typeof(Vectria.MeteorRide.Settings.GeneralSettingsPage).GUID;
            return result;
        }
